...
def load_data(dataset_str, base_dir=''):
    ...
    for i in range(len(names)):
        with open(base_dir + "data/ind.{}.{}".format(dataset_str, names[i]), 'rb') as f:
    ...
    test_idx_reorder = parse_index_file(base_dir + "data/ind.{}.test.index".format(dataset_str))
